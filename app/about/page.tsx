      ...
      <div className="min-h-screen bg-[#FCB9B2] flex flex-col items-center justify-center p-4">
        <div className="bg-white p-6 rounded-xl shadow-lg max-w-3xl w-full">
          ...
          <p className="text-[#461220] text-lg mb-4">
            ...
            controlar tus finanzas, ya sea que lo uses para tu empresa o para
            tus gastos personales. Con nuestra herramienta, podrás:
          </p>
          <ul className="list-disc pl-6 text-[#461220] mb-4">
            ...
            <li>
              Generar reportes claros y detallados para tomar mejores
              decisiones.
            </li>
            <li>Establecer límites y metas financieras personalizadas.</li>
          </ul>
          <p className="text-[#461220] text-lg">
            Administrar tus finanzas nunca había sido tan fácil. Nuestro
            objetivo es brindarte las herramientas necesarias para que puedas
            tener un control total de tu dinero y alcanzar tus metas financieras
